...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument("--m-min", type=int, default=1,
                        help="Minimum chart count from topology certification (M_min)")
...
def main() -> None:
    ...
    if args.n_charts < args.m_min:
        raise ValueError(
            f"n_charts={args.n_charts} < M_min={args.m_min}. "
            f"Topology requires at least {args.m_min} charts."
        )
