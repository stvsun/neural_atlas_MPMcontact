...
convex body where chart and level set coincide. The agreement holds at the field level, not only in the
...
layer, so the transition map stays dormant and chart and level set remain equivalent. Figure~\ref{fig:cv2-traction}
...
contributes only the domain map, and chart and level set are again interchangeable. Figure~\ref{fig:cv3-brazilian}
...
level set stay equivalent. Figure~\ref{fig:cv4-ninedisc} shows the maximum-principal and shear-stress
