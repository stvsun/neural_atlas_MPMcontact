...
def run_score():
    ...
    # C8.S2.1: Convergence order (placeholder)
    checks.append({"id": "C8.S2.1", "name": "Convergence order (not yet impl)", "pass": False, "pts": 0, "max": 15})

    # C8.S2.2: Beam theory F-delta (placeholder)
    checks.append({"id": "C8.S2.2", "name": "Beam theory F-delta (not yet impl)", "pass": False, "pts": 0, "max": 15})
