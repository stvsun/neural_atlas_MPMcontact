"""Stage 3 XFEM-critic tests for Challenge 4: Pure-Shear Fracture.

Has crack -- fracture tests apply:
...
def run_score():
    ...
    dec = CrackTipDecoder.from_crack_tip(
        ...
        opening_direction=opening_dir, radius=0.5,
    ).double()
    ...
    # --- X2: Crack-face traction-free (10 pts) ---
    try:
        # Need a solved displacement field for traction check
